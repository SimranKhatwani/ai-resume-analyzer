...
useEffect(() => {
   ...
   useEffect(() => {
    ...
    try {
      ...
      const pdfBlob :any = new Blob([resumeBlob], {type: 'application/pdf'});
...
{imageUrl && resumeUrl ? (
  ...
  <div className="animate-in fade-in duration-1000 gradient-border max-sm:m-0 h-[90%] max-wxl:h-fit w-fit flex items-center justify-center">
    <img src="/images/resume-scan-2.gif" className="w-full" alt="Loading resume preview" />
  </div>
)}
</section>
...
<div className="flex flex-col gap-8 animate-in fade-in duration-1000">
  ...
  <Details feedback={feedback}/>
    ...
    <img src="/images/resume-scan-2.gif" className="w-full" alt="Loading resume details" />
  )}
